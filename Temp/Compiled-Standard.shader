...
SubShader { 
 ...
 //        d3d11: 155 avg math (137..176), 5 avg texture (3..7), 6 avg branch (6..8)
 Pass {
  Name "FORWARD"
...
//
 ...
 157: mul r2.x, r3.x, r4.x
 158: mad r2.x, -r2.x, l(0.280000), l(1.000000)
 159: dp3 r2.w, r0.xyzx, r0.xyzx
 160: ne r2.w, r2.w, l(0.000000)
 161: and r2.w, r2.w, l(0x3f800000)
 162: mul r1.w, r1.w, r2.w
 163: add r0.w, -r0.w, cb0[8].w
 164: add_sat r0.w, r0.w, l(1.000000)
...
// Approximately 0 instruction slots used
 ...
 // Stats for Fragment shader:
 //        d3d11: 28 avg math (11..42), 4 avg texture (2..5), 0 avg branch (0..2)
 Pass {
  Name "DEFERRED"
...
SubShader { 
 ...
 // Stats for Fragment shader:
 //        d3d11: 106 avg math (50..176), 4 avg texture (4..7), 4 avg branch (2..8)
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="FORWARDBASE" "SHADOWSUPPORT"="true" "RenderType"="Opaque" "PerformanceChecks"="False" }
  ZWrite [_ZWrite]
